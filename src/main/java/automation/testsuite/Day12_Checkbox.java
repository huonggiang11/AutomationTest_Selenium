...
public class Day12_Checkbox extends CommonBase {
	...
	{
		WebElement defaultCheck = driver.findElement(By.xpath("//label[(normalize-space()='Default Checked')]/child::input"));
	...
	{
		WebElement thisCheckbox =driver.findElement(By.xpath("//div[text()='Single Checkbox Demo']//following::label[1]"));
